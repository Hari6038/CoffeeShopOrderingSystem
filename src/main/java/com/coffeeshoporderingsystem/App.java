...
public class App {
	...
	private static void viewAllOrders() {
		...
		for (Order order : orders) {
			if (order.getCustomer() != null) {
				System.out.println("Order ID: " + order.getId() + ", Customer Name: " + order.getCustomer().getName()
	...
	private static void registerCustomer() {
		...
		Customer customer = new Customer(firstname, lastname, email, mobilenumber, password);
